...
/etc/grid-security/cineca/grid-mapfile
file dove controllare i certificati degli utenti.
...
Accedere ad una delle VM, impersonare cinprod, e lanciare il comando per la modifica desiderata.
